...
;-------------------------------------------------------------------------------
		...
		salt_6 db '@ppc'
				 ...
				 dw sys_routine_seg_sel		
		salt_7 db '@clear'
				 times 256-($-salt_7) db 0
				 dd clear
				 dw sys_routine_seg_sel
				 	
         salt_item_len   equ $-salt_7
         salt_items      equ ($-salt)/salt_item_len

         welcome_word        db  '  Welcome to use my os!!'
                          db  'You can type 1 to 4 to run a corresponding program!',0x0d,0x0a
                          db  'When running them,type q to return to core',0x0d,0x0a,0
...
start:
         ...
         mov ds,ecx
    ;     mov bx,(80*3+0)
    ;     call sys_routine_seg_sel:set_cur
	; 	mov cl,al
 	;	call sys_routine_seg_sel:ppc
    ;	mov cl,'@'
	;	call sys_routine_seg_sel:ppc
re_point:	
		call sys_routine_seg_sel:clear
		
         mov ebx,welcome_word
